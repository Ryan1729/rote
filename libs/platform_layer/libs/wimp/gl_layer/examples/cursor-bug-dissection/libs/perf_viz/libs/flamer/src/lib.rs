// This was based on https://github.com/llogiq/flamer/tree/1a886b06f098e4f808120606a9c5a09a163985d1
// The code is licensed under the Apache 2.0 license, as described in the license file included in
// this crate. This file has been modified from its original form.
...
impl Fold for Flamer {
    ...
    fn fold_item_fn(&mut self, i: ItemFn) -> ItemFn {
        ...
        let stmts = ::std::mem::replace(&mut i.block.stmts, vec![parse_quote! {
            let _flame_guard = perf_viz::flame_start_guard(#name);
        }]);
        for stmt in stmts {
